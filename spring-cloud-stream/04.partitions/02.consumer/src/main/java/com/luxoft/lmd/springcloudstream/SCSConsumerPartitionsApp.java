...
public class SCSConsumerPartitionsApp {
	@Bean public ContractorSpendingCalculator contractorSpendingCalculator() {
		return new ContractorSpendingCalculatorImpl();
	}

	public static void main(String[] args) {
		SpringApplication.run(SCSConsumerPartitionsApp.class, args);
	}
}
